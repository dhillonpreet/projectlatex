...
% 4th. author
\alignauthor Harshvardhan\\
       \affaddr{Dept. of Compute Science}\\
       \affaddr{IIT Ropar}\\
       \email{2016csb1120@iitrpr.ac.in}
% 5th. author
\alignauthor Prinshu Kumar\\
       \affaddr{Dept. of Computer Science}\\
       \affaddr{IIT Ropar}\\
...
\begin{figure}
\centering
\includegraphics[width=8cm]{tab1.png}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[height = 8cm,width=8cm]{tab2.png}
...
\begin{figure}
\centering
\includegraphics[height = 8cm,width=8cm]{tab3.png}
...
\begin{figure}
\centering
\includegraphics[height = 8cm,width=8cm]{tab4.png}
\end{figure}
...
\begin{figure*}
\centering
\includegraphics[height = 10cm,width=16cm]{fi6.png}
\caption{Selected frames from the recordings: (a-d) P1, (e-h) P2, (i-l) P3}
\end{figure*}

\begin{figure*}
\centering
\includegraphics[height = 10cm,width=16cm]{tab6.png}
\end{figure*}
